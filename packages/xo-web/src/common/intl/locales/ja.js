...
export default {
  ...
  "XOAは正常にアップデートされました。ブラウザでのリロードが必要です。リロードしますか？",
  ...
  disclaimerText1:  "このバージョンは、ソースコードよりインストールされた開発版です！ 個人や、非営利での利用に最適です。",

  // Original text: "If you are a company, it's better to use it with our appliance + pro support included:"
  disclaimerText2:  "企業利用の場合、プロサポートが含まれるアプライアンスを利用することを推奨します。:",

  // Original text: "This version is not bundled with any support nor updates. Use it with caution for critical tasks."
  disclaimerText3:  "このバージョンは開発中のものであり、サポート、アップデートはできません。クリティカルな用途には、細心の注意を払ってご利用ください。",
